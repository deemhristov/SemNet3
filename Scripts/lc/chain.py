...
class WordNetHypernymResolver:
    def __init__(self, model):
        self.wn_data_prompt = PromptTemplate(
            ...
            template="""{% for synset in synsets %}
            ## Data for {{ synset.id }}
            ...
            {% endfor %}
            {% for relation in synset.holonyms %}
            ...
            {% endfor %}
            {% for relation in synset.meronyms %}
            ...
            {% endfor %}
            {% for relation in synset.domains %}
            ...
            {% endfor %}
            {% for relation in synset.domain_members %}
            ...
            {% endfor %}
            {% for relation in synset.other_relations %}
            ...
            {% else %}
            {{ synset.id }} has a derivationally related form relation to {{ relation.id }}.
            I.e. {{ relation.id }} is a derivationally related form of {{ synset.id }} and {{ synset.id }} is a derivationally related form of {{ relation.id }}.
            {% endif %}
            {% endfor %}
            {% endfor %}
            """
    ...
    def run(self, instructions, rules, wn_data, output_format):
